...
test('Testing chop function', t => {
  ...
  t.notEqual(numberIndex(50, [1, 2, 8, 12, 50, 50, 75,80]), 5, 'test when the number occures more than ones is in the first half of the array and the element\'s number in the array is even, make sure it won\'t give back the second occurance');
