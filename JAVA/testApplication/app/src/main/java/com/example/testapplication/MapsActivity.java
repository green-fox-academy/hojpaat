...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    final static String[] PERMISSION = {Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION};
    ...
    private void showAlert(){
        ...
        if(status == 1) {
            ...
            message = "Please allow this app to acces Location";
        ...
        dialog.setTitle(title)
                ...
                .setPositiveButton(btnText, onClick(paramDialogInterface, paramInt) -> {
                    ...
                    } else requestPermissions(PERMISSION, PERMISSION_ALL);
        })
